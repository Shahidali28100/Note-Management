...
// backend's "after trimming" rule. tagIds (AB-1006) is optional — missing means no tags assigned;
// ownership of each id is a backend concern (InvalidTagReferenceException), not expressed here.
...
// (packages/shared/CLAUDE.md). AB-1006 adds tagId — ownership validation is a backend concern.
